...
// 开始测量
export function _api_startMeasurement(
  data: StartMeasurementRequest,
  headers = {},
...
// 上传测量数据
export function _api_uploadMeasurementData(
...
// 结束测量
export function _api_endMeasurement(
  data: EndMeasurementRequest,
  headers = {},
): Promise<ApiResponse<any>> {
...
// 获取测量历史
export function _api_getMeasurementHistory(
...
// 获取测量详情
export function _api_getMeasurementDetail(
  measurementId: number,
  headers = {},
): Promise<ApiResponse<any>> {
...
// 删除测量记录
export function _api_deleteMeasurement(
  measurementId: number,
  headers = {},
): Promise<ApiResponse<any>> {
