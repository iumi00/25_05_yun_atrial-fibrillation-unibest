...
export const login = (loginForm: ILoginForm) => {
  console.log('🚨 登录请求使用完整URL: http://localhost:8000/api/user/login')
  return http.post<IUserLogin>('http://localhost:8000/api/user/login', loginForm)
}
...
export const getUserInfo = () => {
  console.log('🚨 getUserInfo请求使用完整URL: http://localhost:8000/api/user/info')
  return http.get<IUserInfoVo>('http://localhost:8000/api/user/info')
}
 ...
 */
export const logout = () => {
  console.log('🚨 logout请求使用完整URL: http://localhost:8000/api/user/logout')
  return http.get<void>('http://localhost:8000/api/user/logout')
}
...
export const updateInfo = (data: IUpdateInfo) => {
  console.log('🚨 updateInfo请求使用完整URL: http://localhost:8000/api/user/updateInfo')
  return http.post('http://localhost:8000/api/user/updateInfo', data)
}
